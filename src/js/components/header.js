  ...
  <div class=' flex items-center '> 
        <nav class="hidden text-2xl text-black dark:text-white md:block" aria-label="Main Navigation">
            <ul class="flex flex-row justify-center space-x-8" role="menu">
                <li role="none">
                <button><a role="menuitem" class="hover:text-primary bg-background-dark rounded-full  text-white dark:hover:text-primary" href="/profile/" aria-label="View Profile">
                ...
                <li role="none">
                    <button role="menuitem" class="hover:text-button dark:hover:text-primary logout-btn" aria-label="Log out"><svg class="w-[31px] h-[31px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
<ul class="flex lg:space-x-4 space-x-2"> 
  ...
  <a href="/auth/register/" class=" text-white hover:bg-primary_hover bg-primary px-4 py-2 rounded-lg  dark:text-white dark:hover:text-white font-medium lg:mr-4">
Sign up
    </a>
    </li>
  </ul>
...
>
    ...
    <nav class=" absolute flex text-center mt-2 right-0 min-w-[180px] bg-white shadow-md p-2 rounded-md">
      ...
      >
        ...
        <a id="my-profile-link" class="ml-2 text-background-dark">My Profile</a>
      </li>
      <li
      role="option"
      aria-label="Create Post"
      class="cursor-pointer flex items-center p-3 text-background-dark hover:bg-gray-100"
    >
      <i class="fa-regular fa-square-plus text-primary"></i>
      <a href="/post/create/" id="create-btn" class="ml-2 text-background-dark"
        >Create Post</a
      >
    </li>
    <hr class="my-2 border-slate-200" />
            ...
            class="cursor-pointer flex items-center p-3 hover:bg-gray-100">
                ...
                <i class="fa-solid fa-right-from-bracket text-primary"></i> Logout</button>
            </li>
        </ul>
    </nav>
</div>
  ...
  header.innerHTML = `
    ...
    <div class='grid grid-flow-col items-center justify-between py-3 px-4 sm:px-10 bg-background-light dark:bg-background-dark lg:gap-y-4 gap-y-6 gap-x-4'>
        ...
        >
            <label id="search-menu-label" class="sr-only" for="searchbar-field">Search Menu</label>
            <div
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192.904 192.904" width="16px" class="fill-primary dark:fill-background-dark mr-3 rotate-90" role="img" aria-hidden="true">
                ...
                <input
                    ...
                    id="searchbar-field"
                    placeholder="Search..."
                    class="w-full outline-none dark:text-white bg-transparent text-sm"
                    aria-label="Search"
                />
            </div>
        </div>
